...
@section('title', trans('staff_manage.page_title'))
@section('icon', 'id-card')
@section('subtitle', trans('staff_manage.subtitle'))
...
@section('content')
            ...
            <div class="main-card mb-3 card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="javascript:void(0)" class="text-muted text-decoration-none" data-bs-toggle="collapse" data-bs-target="#staff-search-collapse" aria-expanded="true" id="staff-collapse-toggle">
                        {{ trans('staff_manage.action_collapse') }}
                    </a>
                </div>
                ...
                <div class="card-body pt-3">
                    <div class="row g-3 mb-3">
                        <div class="col-md-3 col-6">
                            <label class="form-label fw-bold">{{ trans('staff_manage.field_account') }}：</label>
                            <input type="text" class="form-control" id="staff-search-account" placeholder="{{ trans('staff_manage.field_account') }}">
                        </div>
                        <div class="col-md-3 col-6">
                            <label class="form-label fw-bold">{{ trans('staff_manage.field_nickname') }}：</label>
                            <input type="text" class="form-control" id="staff-search-name" placeholder="{{ trans('staff_manage.field_nickname') }}">
                        </div>
                        <div class="col-md-3 col-6">
                            <label class="form-label fw-bold">{{ trans('staff_manage.field_level') }}：</label>
                            <select class="form-select" id="staff-search-level">
                                <option value="">{{ trans('staff_manage.filter_all') }}</option>
                                {!! \App\Presenters\UserPresenter::levelOptions([0]) !!}
                            </select>
                        </div>
                        <div class="col-md-3 col-12">
                            <label class="form-label fw-bold">{{ trans('staff_manage.filter_tenure') }}：</label>
                            <div class="input-group flex-nowrap">
                                <select class="form-select" id="staff-search-tenure-op" style="max-width:90px">
                                    <option value="">{{ trans('staff_manage.filter_unlimited') }}</option>
                                    <option value="gte">≥</option>
                                    <option value="lte">≤</option>
                                </select>
                                <input type="number" class="form-control" id="staff-search-tenure-years" placeholder="{{ trans('staff_manage.unit_year') }}" min="0" step="1">
                                <span class="input-group-text">{{ trans('staff_manage.unit_year') }}</span>
                                <input type="number" class="form-control" id="staff-search-tenure-months" placeholder="{{ trans('staff_manage.unit_month') }}" min="0" max="11" step="1">
                                <span class="input-group-text">{{ trans('staff_manage.unit_month') }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <button type="button" class="btn btn-outline-secondary" id="btn-staff-reset">{{ trans('staff_manage.action_reset') }}</button>
                        <button type="button" class="btn btn-primary" id="btn-staff-search">
                            <i class="fas fa-search me-1"></i>{{ trans('staff_manage.action_search') }}
                        </button>
                    </div>
                </div>
                </div>{{-- end collapse --}}
                    ...
                    <div class="table-responsive d-none d-md-block">
                        <table class="table table-hover table-striped align-middle mb-0">
                            ...
                            <tbody id="staff-table-body">
                                <tr><td colspan="8" class="text-center text-muted py-4">{{ trans('staff_manage.loading') }}</td></tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="d-md-none" id="staff-card-list">
                        <p class="text-muted text-center py-4">{{ trans('staff_manage.loading') }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="main-card mb-3 card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-primary" id="btn-open-add-eq">
                            <i class="fas fa-plus me-1"></i>{{ trans('staff_manage.add_equipment') }}
                        </button>
                        @endif
                    </div>
                ...
                <div class="card-body pt-3">
                    <div class="row g-3 mb-3">
                        <div class="col-md-3 col-6">
                            <label class="form-label fw-bold">{{ trans('staff_manage.field_account') }}：</label>
                            <input type="text" class="form-control" id="eq-search-account" placeholder="{{ trans('staff_manage.field_account') }}">
                        </div>
                        <div class="col-md-3 col-6">
                            <label class="form-label fw-bold">{{ trans('staff_manage.field_nickname') }}：</label>
                            <input type="text" class="form-control" id="eq-search-name" placeholder="{{ trans('staff_manage.field_nickname') }}">
                        </div>
                        <div class="col-md-3 col-6">
                            <label class="form-label fw-bold">{{ trans('staff_manage.field_eq_name') }}：</label>
                            <input type="text" class="form-control" id="eq-search-eq" placeholder="{{ trans('staff_manage.field_eq_name') }}">
                        </div>
                        <div class="col-md-3 col-6">
                            <label class="form-label fw-bold">{{ trans('staff_manage.field_serial') }}：</label>
                            <input type="text" class="form-control" id="eq-search-serial" placeholder="{{ trans('staff_manage.field_serial') }}">
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-md-3 col-12">
                            <label class="form-label fw-bold">{{ trans('staff_manage.filter_duration') }}：</label>
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="number" class="form-control" id="eq-search-duration-years" placeholder="{{ trans('staff_manage.unit_year') }}" min="0" step="1">
                                <span class="input-group-text">{{ trans('staff_manage.unit_year') }}</span>
                                <input type="number" class="form-control" id="eq-search-duration-months" placeholder="{{ trans('staff_manage.unit_month') }}" min="0" max="11" step="1">
                                <span class="input-group-text">{{ trans('staff_manage.unit_month') }}</span>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <label class="form-label fw-bold">{{ trans('staff_manage.field_status') }}：</label>
                            <select class="form-select" id="eq-search-status">
                                <option value="">{{ trans('staff_manage.filter_all') }}</option>
                                <option value="in_use">{{ trans('staff_manage.eq_in_use') }}</option>
                                <option value="returned">{{ trans('staff_manage.eq_returned') }}</option>
                                <option value="not_received">{{ trans('staff_manage.eq_not_received') }}</option>
                            </select>
                        </div>
                        <div class="col-md-3 col-6">
                            <label class="form-label fw-bold">{{ trans('staff_manage.label_sort') }}：</label>
                            <select class="form-select" id="eq-sort">
                                <option value="id">{{ trans('staff_manage.sort_default') }}</option>
                                <option value="received_desc">{{ trans('staff_manage.sort_received_desc') }}</option>
                                <option value="received_asc">{{ trans('staff_manage.sort_received_asc') }}</option>
                                <option value="duration_desc">{{ trans('staff_manage.sort_duration_desc') }}</option>
                                <option value="duration_asc">{{ trans('staff_manage.sort_duration_asc') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end gap-2">
                        <button type="button" class="btn btn-outline-secondary" id="btn-eq-reset">{{ trans('staff_manage.action_reset') }}</button>
                    ...
                    <div class="table-responsive d-none d-md-block">
                        <table class="table table-hover table-striped align-middle mb-0">
                            ...
                            <tbody id="eq-table-body">
                                <tr><td colspan="10" class="text-center text-muted py-4">{{ trans('staff_manage.loading') }}</td></tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staff-edit-title">{{ trans('staff_manage.edit_staff') }}</h5>
                ...
                <div class="modal-body">
                    <form id="form-staff-edit">
                        ...
                        <div class="mb-3">
                            <label class="form-label">{{ trans('staff_manage.field_hired_at') }}</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">{{ trans('staff_manage.field_resigned_at') }}</label>
                            <input id="staff-resigned-at" type="date" class="form-control">
                        </div>
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ trans('staff_manage.action_cancel') }}</button>
                            <button type="submit" class="btn btn-primary">{{ trans('staff_manage.action_save') }}</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="modal-eq-edit" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="eq-edit-title">{{ trans('staff_manage.equipment_manage') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" id="modal-add-eq" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ trans('staff_manage.add_equipment') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form id="form-add-eq">
                        <div class="mb-3">
                            <label class="form-label">{{ trans('staff_manage.field_holder') }} <span class="text-danger">*</span></label>
                            <select id="add-eq-user" class="form-select" required>
                                <option value="">{{ trans('staff_manage.please_select') }}</option>
                        ...
                        <div class="mb-3">
                            <label class="form-label">{{ trans('staff_manage.field_eq_name') }} <span class="text-danger">*</span></label>
                            <input id="add-eq-name" type="text" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">{{ trans('staff_manage.field_model') }}</label>
                            <input id="add-eq-model" type="text" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">{{ trans('staff_manage.field_serial') }}</label>
                            <input id="add-eq-serial" type="text" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">{{ trans('staff_manage.field_received_at') }}</label>
                            <input id="add-eq-received-at" type="date" class="form-control">
                        </div>
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ trans('staff_manage.action_cancel') }}</button>
                            <button type="submit" class="btn btn-primary">{{ trans('staff_manage.action_add') }}</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body text-center py-4">
                    ...
                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ trans('staff_manage.action_cancel') }}</button>
                        <button type="button" class="btn btn-primary" id="btn-eq-return-ok">{{ trans('staff_manage.action_confirm_return') }}</button>
                    </div>
                </div>
            </div>
        </div>
...
$(function () {
    ...
    var I18N = @json(trans('staff_manage'));
    ...
    function renderStaffCards(list) {
        ...
        if (!list.length) { $c.html('<p class="text-muted text-center py-4">' + I18N.no_data + '</p>'); return; }
        var html = '';
        list.forEach(function (s) {
    ...
    function bindStaffEdit() {
        $('.js-staff-edit').off('click').on('click', function () {
            ...
            $('#staff-edit-title').text(I18N.action_edit + ' - ' + $btn.data('nickname'));
    ...
    function calcTenure(dateStr) {
        ...
        var now = new Date();
        now.setHours(0, 0, 0, 0);
        if (hired > now) { $el.text(I18N.not_yet_hired); return; }
        ...
        if (m < 0) { y--; m += 12; }
        var parts = [];
        if (y > 0) parts.push(y + ' ' + I18N.unit_year);
        if (m > 0) parts.push(m + ' ' + I18N.unit_month);
        if (d > 0) parts.push(d + ' ' + I18N.unit_day);
        $el.text(parts.length ? I18N.tenure_prefix + parts.join(' ') : I18N.hired_today);
    }
    ...
    $('#form-staff-edit').on('submit', function (e) {
        ...
        $.ajax({
            ...
            data: JSON.stringify({
                hired_at: $('#staff-hired-at').val() || null,
                resigned_at: $('#staff-resigned-at').val() || null,
            }),
            success: function (body) {
                hideBsModal(document.getElementById('modal-staff-edit'));
                setTimeout(function () { showMsg(body.message || I18N.msg.updated); loadList(); }, 400);
            },
            error: function (xhr) { showMsg((xhr.responseJSON && xhr.responseJSON.message) || I18N.msg.update_failed); }
        });
    });
    ...
    function calcEqDuration(receivedAt, returnedAt) {
        ...
        if (y > 0) parts.push(y + I18N.unit_year);
        if (m > 0) parts.push(m + I18N.unit_month);
        parts.push(d + I18N.unit_day);
        return (returnedAt ? '' : I18N.duration_used) + parts.join(' ');
    }

    function eqStatusBadge(eq) {
        if (eq.returned_at) return '<span class="badge bg-secondary">' + I18N.eq_returned + '</span>';
        if (eq.received_at) return '<span class="badge bg-success">' + I18N.eq_in_use + '</span>';
        return '<span class="badge bg-warning text-dark">' + I18N.eq_not_received + '</span>';
    }
    ...
    function renderEqCards(list) {
        ...
        if (!filtered.length) { $c.html('<p class="text-muted text-center py-4">' + I18N.no_equipment + '</p>'); return; }
    ...
    function bindEqReturn() {
        $('.js-eq-return').off('click').on('click', function () {
            ...
            var eqName = $(this).data('eq-name') || I18N.field_equipment;
            ...
            var confirmHtml = '<p><strong>' + I18N.return_confirm + '</strong></p>';
            confirmHtml += '<table class="table table-sm text-start mt-2"><tbody>';
            confirmHtml += '<tr><th style="width:80px">' + I18N.field_staff + '</th><td>' + userName + '</td></tr>';
            confirmHtml += '<tr><th>' + I18N.field_equipment + '</th><td>' + eqName + '</td></tr>';
            if (eq.model) confirmHtml += '<tr><th>' + I18N.field_model + '</th><td>' + eq.model + '</td></tr>';
            if (eq.serial) confirmHtml += '<tr><th>' + I18N.field_serial + '</th><td>' + eq.serial + '</td></tr>';
            if (eq.received_at) confirmHtml += '<tr><th>' + I18N.field_received_at + '</th><td>' + eq.received_at + '</td></tr>';
            confirmHtml += '<tr><th>' + I18N.return_date + '</th><td><strong>' + new Date().toISOString().substring(0, 10) + '</strong>（' + I18N.today + '）</td></tr>';
            var dur = calcEqDuration(eq.received_at, null);
            if (dur) confirmHtml += '<tr><th>' + I18N.field_duration + '</th><td>' + dur + '</td></tr>';
    ...
    $('#btn-eq-return-ok').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (body) {
                ...
                setTimeout(function () { showMsg(body.message || I18N.msg.returned); loadList(); }, 400);
                $btn.prop('disabled', false);
            },
            error: function (xhr) {
                hideBsModal(document.getElementById('modal-eq-return-confirm'));
                setTimeout(function () { showMsg((xhr.responseJSON && xhr.responseJSON.message) || I18N.msg.action_failed); }, 400);
                $btn.prop('disabled', false);
            }
        });
    });
    ...
    function renderEquipments(list) {
        ...
        $c.empty();
        if (!list.length) { $c.html('<p class="text-muted mb-0" style="font-size:0.875rem">' + I18N.no_equipment_yet + '</p>'); return; }
        list.forEach(function (eq, idx) {
            ...
            html += '<div class="col-md-4"><input type="text" class="form-control form-control-sm js-eq-name" placeholder="' + I18N.field_eq_name + '" value="' + (eq.name || '').replace(/"/g, '&quot;') + '"></div>';
            html += '<div class="col-md-4"><input type="text" class="form-control form-control-sm js-eq-model" placeholder="' + I18N.field_model + '" value="' + (eq.model || '').replace(/"/g, '&quot;') + '"></div>';
            html += '<div class="col-md-4"><input type="text" class="form-control form-control-sm js-eq-serial" placeholder="' + I18N.field_serial + '" value="' + (eq.serial || '').replace(/"/g, '&quot;') + '"></div>';
            html += '</div>';
            html += '<div class="row g-2">';
            html += '<div class="col-md-4"><label style="font-size:0.75rem" class="text-muted">' + I18N.field_received_at + '</label><input type="date" class="form-control form-control-sm js-eq-received-at" value="' + (eq.received_at || '') + '"></div>';
            html += '<div class="col-md-4"><label style="font-size:0.75rem" class="text-muted">' + I18N.field_returned_at + '</label><input type="date" class="form-control form-control-sm js-eq-returned-at" value="' + (eq.returned_at || '') + '"></div>';
    ...
    $('#form-add-eq').on('submit', function (e) {
        ...
        if (!userId) { showMsg(I18N.please_select + I18N.field_holder); return; }
        ...
        $.ajax({
            ...
            success: function (body) {
                ...
                setTimeout(function () { showMsg(body.message || I18N.msg.added); loadList(); }, 400);
            },
            error: function (xhr) { showMsg((xhr.responseJSON && xhr.responseJSON.message) || I18N.msg.action_failed); }
        });
    });
    ...
    $staffCollapse.on('show.bs.collapse', function () { $staffToggle.text(I18N.action_collapse); });
    $staffCollapse.on('hide.bs.collapse', function () { $staffToggle.text(I18N.action_expand); });

    // 折疊切換
    var $eqCollapse = $('#eq-search-collapse');
    var $eqToggle = $('#eq-collapse-toggle');
    $eqCollapse.on('show.bs.collapse', function () { $eqToggle.text(I18N.action_collapse); });
    $eqCollapse.on('hide.bs.collapse', function () { $eqToggle.text(I18N.action_expand); });
