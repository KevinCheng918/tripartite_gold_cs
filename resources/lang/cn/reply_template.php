...
return [
    ...
    'full'       => '完整版',
    'short'      => '精简版',
    'full_hint'  => '距离上次自动回复超过 :minutes 分钟时使用，含问候语。',
    'short_hint' => '连续对话时使用，省略开头问候避免显得罐头。',
    ...
    'answer_desc'  => '从题库挑到答案时发送。',
    'clarify_desc' => '同时像好几题时，客气地请客人确认是哪一项。',
    'wait_desc'    => '题库里没有答案时发送，同时会把问题转到内部支援群组。',
